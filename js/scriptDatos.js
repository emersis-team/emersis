var recursos = [
	{ id: 0, nombre: "Camión Transporte", tipo: "Vehículo" },
	{ id: 1, nombre: "Ambulancia", tipo: "Vehículo" },
	{ id: 2, nombre: "Camas Portátiles", tipo: "Insumo" },
	{ id: 3, nombre: "Máscara de protección", tipo: "Insumo" },
	{ id: 4, nombre: "Gasa", tipo: "Insumo" },
	{ id: 5, nombre: "Frasada", tipo: "Insumo" },
	{ id: 6, nombre: "Patrullero", tipo: "Vehículo" },
	{ id: 7, nombre: "Guantes Médicos", tipo: "Insumo" },
	{ id: 8, nombre: "Fuerzas de Seguridad", tipo: "Personal" },
	{ id: 9, nombre: "Personal de Asistencia", tipo: "Personal" },
	{ id: 10, nombre: "Agua", tipo: "Insumo" }
];
...
var entidades = [
  {
    ...
    capacidades: [
      { id: 0, recurso: recursos[2], cantidad: 1000 },
      { id: 1, recurso: recursos[1], cantidad: 50 }
    ],
    necesidades: [
      { id: 2, recurso: recursos[4], cantidad: 5000 },
      { id: 3, recurso: recursos[5], cantidad: 266 }
    ]
  },
  {
    id: 1,
    ...
    capacidades: [
      { id: 4, recurso: recursos[6], cantidad: 100 },
      { id: 5, recurso: recursos[8], cantidad: 20 }
    ],
    necesidades: [
      { id: 6, recurso: recursos[8], cantidad: 50 },
      { id: 7, recurso: recursos[0], cantidad: 1 }
    ]
  },
  {
    id: 2,
    ...
    capacidades: [
      { id: 8, recurso: recursos[2], cantidad: 500 },
      { id: 9, recurso: recursos[9], cantidad: 50 }
    ],
    necesidades: [
      { id: 10, recurso: recursos[2], cantidad: 300 },
      { id: 11, recurso: recursos[0], cantidad: 50 },
	  { id: 12, recurso: recursos[10], cantidad: 50000 }
    ]
  }
];
